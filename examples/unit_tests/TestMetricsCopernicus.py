...
class TestMetricsCopernicus(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.metrics = MetricsCopernicus(self.mock_raster_data, self.mock_vector_traffic_area, self.mock_ghs_pop_data)

    @patch('greento.metrics.MetricsCopernicus.tqdm')
    ...
    @patch('greento.metrics.MetricsCopernicus.tqdm')
    @patch('greento.metrics.MetricsCopernicus.ox.graph_from_gdfs')
    @patch('greento.metrics.MetricsCopernicus.ox.distance.nearest_nodes')
