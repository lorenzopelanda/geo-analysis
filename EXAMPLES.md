...
This example demonstrates how to filter the downloaded data from OpenStreetMap to get only the green areas for a bounding box using `green.osm` class.
...
This example demonstrates how to filter the downloaded data from Copernicus to get only the green areas for a bounding box using `green.copernicus` class.
...
This example demonstrates how to get the traffic network map of the bounding box selected using the `traffic.traffic` class.
...
### Get the traffic network with `traffic.traffic` class
