...
class TestVectorUtils(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.vector_utils = VectorUtils((self.mock_nodes, self.mock_edges))
    ...
    def test_get_land_use_percentages_empty(self):
        ...
        vector_utils = VectorUtils((empty_nodes, empty_edges))
    ...
    def test_to_raster_invalid_nodes(self):
        ...
        vector_utils = VectorUtils((invalid_nodes, self.mock_edges))
    ...
    def test_to_raster_invalid_edges(self):
        ...
        vector_utils = VectorUtils((self.mock_nodes, invalid_edges))
