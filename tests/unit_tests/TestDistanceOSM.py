...
class TestDistanceOSM(unittest.TestCase):
    def setUp(self):
        ...
        self.distance_osm = DistanceOSM(
            self.mock_osm_green, 
            self.mock_vector_traffic_area
        )

    @patch('greento.distance.DistanceOSM.ox')
    @patch('greento.distance.DistanceOSM.GeoUtils')
    @patch('greento.distance.DistanceOSM.cKDTree')
    @patch('greento.distance.DistanceOSM.nx')
    @patch('greento.distance.DistanceOSM.tqdm')
