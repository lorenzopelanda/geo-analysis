...
class TestMetricsOSM(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.metrics = MetricsOSM(self.mock_osm_data, self.mock_vector_traffic_area, self.mock_ghs_pop_data)

    @patch('greento.metrics.MetricsOSM.tqdm')
    ...
    @patch('greento.metrics.MetricsOSM.tqdm')
    @patch('greento.metrics.MetricsOSM.ox.graph_from_gdfs')
    @patch('greento.metrics.MetricsOSM.ox.distance.nearest_nodes')
    def test_get_isochrone_green_basic(self, mock_nearest_nodes, mock_graph_from_gdfs, mock_tqdm):      
        ...
        self.metrics.osm_file['transform'] = transform_mock
        ...
        self.metrics.osm_file['data'] = np.array([[0, 1], [1, 0]])
